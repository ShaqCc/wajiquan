package com.wjq.share.activity;
...
import com.wjq.share.MyApp;
import com.wjq.share.adapter.ProductAdapter;
import com.wjq.share.bean.CarDetailBean;
import com.wjq.share.bean.CarInfoBean;
import com.wjq.share.bean.MomentBean;
import com.wjq.share.bean.PushBean;
import com.wjq.share.bean.QiugouBean;
...
import com.wjq.share.service.CarListService;
import com.wjq.share.service.QiuGouService;
import com.wjq.share.utils.PermissionUtils;
import com.wjq.share.utils.SpUtils;
import com.wjq.share.view.ProgressView;
        ...
        public Notification getNotification(Context context, final UMessage uMessage) {
            ...
            switch (uMessage.builder_id) {
                case 1:
                    ...
                    myNotificationView.setImageViewResource(R.id.notification_small_icon, R.mipmap.ic_launcher_128);
                    builder.setContent(myNotificationView)
                            .setSmallIcon(R.mipmap.ic_launcher_128)
                        ...
                        if (body != null) {
                            if (body.getCode() == 0) {
                                ...
                                if (urlList.size() > 0 && mWeakReference.get() != null) {
                                    Intent intent = new Intent();
                                    intent.setClass(mWeakReference.get(), DownPicService.class);
                                    intent.putExtra(Constants.KEY_SHARE_METE_DATA, new ShareMeteBean(urlList, getInformation(body)));
                                    //开启下载服务
                                    startService(intent);
                                }
                            }
